...
CREATE TABLE `uw_user`  (
  ...
  `gold` int(11) UNSIGNED NOT NULL DEFAULT 9999999 COMMENT '金币',
  `diamond` int(11) NOT NULL DEFAULT 9999999 COMMENT '钻石',
  `giveDiamond` int(11) NOT NULL DEFAULT 9999999 COMMENT '绑定钻石，即送的钻石',
  `buyDiamond` int(11) NOT NULL DEFAULT 9999999 COMMENT '非绑定钻石，即购买的钻石',
