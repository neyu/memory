...
CREATE TABLE `uw_hero`  (
  ...
  `tempId` int(6) NOT NULL DEFAULT 0 COMMENT '模板id',
  `quality` int(4) NOT NULL DEFAULT 0 COMMENT '品阶',
  `intensifyArr` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '强化[等级,等级,...] 下标对应装备位置',
  `starArr` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '星级[星级,星级,...] 下标对应装备位置',
  `gemArr` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '宝石[id,id,id,...]下标对应装备位置',
  `wingArr` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '翅膀[id,等级,星级,当前星经验]',
  `expc` int(7) NOT NULL DEFAULT 0 COMMENT '经验',
  `lvl` int(4) NOT NULL DEFAULT 0 COMMENT '等级',
  `equipData` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '{\"部位\":物品id,....}',
  `skillLvlArr` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '[技能1等级,技能2等级...]',
  `propArr` varchar(700) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '属性组',
  `realmLvl` int(4) NOT NULL DEFAULT 0 COMMENT '境界等级',
  `realmArr` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '境界符文组',
  `sex` int(4) NOT NULL DEFAULT 0 COMMENT '性别',
  `combat` int(11) NOT NULL DEFAULT 0 COMMENT '战斗力',
  `refineArr` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '装备精炼',
  `starTopArr` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '升星突破',
  `talismanAdorn` int(7) NOT NULL DEFAULT 0 COMMENT '法宝佩戴',
  `talismanData` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '法宝数据{法宝id:[等级,资质,星级,最高星级,{星级:技能id,星级:技能id,...},临时资质],法宝id:[等级,资质,星级,最高星级,{星级:技能id,星级:技能id,...},临时资质],....}',
  `talismanFg` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '法宝共鸣{共鸣id:[0,1],共鸣id:[1,0],...}',
