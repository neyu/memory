...
var (
	...
	// 服务发现地址
	flagDiscoveryAddr = CommandLine.String("sdaddr", "127.0.0.1:8080", "Discovery address")
	...
	flagWANIP = CommandLine.String("wanip", "127.0.0.1", "Client connect from extern ip")
